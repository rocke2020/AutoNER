...
python test_partial_ner.py --input_corpus $MODEL_ROOT/encoded_test.pk --checkpoint_folder $CHECKPOINT \
    --output_text $MODEL_ROOT/decoded.txt --hid_dim 300 --droprate 0.5 --word_dim 200 \
    --layer_norm